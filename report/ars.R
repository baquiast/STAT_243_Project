...
#' Adaptive Rejection Sampler is 
#' @param n Number of samples.
#' @param f Density.
#' @param fprima Density.
#' @param log.transform Density.
#' @param x.start Density.
#' @param domain Density.
#' @param plot.type Density.
#' @param pdf.name Density.
...
ars = function(n, f, ..., fprima=NULL, log.transform=FALSE, x.start=NULL, domain=c(-Inf,Inf), plot.type = "none",pdf.name=""){ 
