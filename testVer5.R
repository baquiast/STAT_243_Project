...
test_that("sampling ok",{
  ...
  y <- ars(100,dnorm,mean=0,sd=1,x.start=c(-4,4))
...
### Summary
mysample = ars(n = 100,dgamma, shape=1, scale=1, x.start=c(0.001,2),
               plot.type="bounds")
mysample = ars(n = 100,dgamma, shape=1, scale=1, x.start=c(0.001,2),
               plot.type="acceptance")
mysample = ars(n = 100,dgamma, shape=1, scale=1, plot.type="bounds", domain=c(0,Inf))
mysample = ars(n = 100,dgamma, shape=1, scale=1, plot.type="acceptance", domain=c(0,Inf))

### Test without given starting values: Valid
test_that("sampling ok",{
  x <- rgamma(100,shape=1,scale=1)
  y <- ars(100,dgamma,shape=1,scale=1,domain=c(0,Inf))
  wilcox_test <- wilcox.test(x, y, 
                             alternative = c("two.sided", "less", "greater"),
                             mu = 0, paired = FALSE, exact = NULL, correct = TRUE,
                             conf.int = FALSE, conf.level = 0.95)$p.value
...
test_that("sampling ok",{
  x <- rgamma(100,shape=1,scale=1)
  y <- ars(100,dgamma,shape=1,scale=1,x.start=c(0.001,2))
  wilcox_test <- wilcox.test(x, y, 
                             alternative = c("two.sided", "less", "greater"),
                             mu = 0, paired = FALSE, exact = NULL, correct = TRUE,
                             conf.int = FALSE, conf.level = 0.95)$p.value
...
### Summary
mysample = ars(n = 100,dbeta, shape1=1.3, shape2=2.7, x.start=c(0.001,0.999),
               plot.type="bounds")
mysample = ars(n = 100,dbeta, shape1=1.3, shape2=2.7, x.start=c(0.001,0.999),
               plot.type="acceptance")
...
test_that("sampling ok",{
  x <- rbeta(100,shape1=1.3,shape2=2.7)
  y <- ars(100,dbeta,shape1=1.3,shape2=2.7, x.start=c(0.0525368,0.9474632))
  wilcox_test <- wilcox.test(x, y, 
                             alternative = c("two.sided", "less", "greater"),
                             mu = 0, paired = FALSE, exact = NULL, correct = TRUE,
                             conf.int = FALSE, conf.level = 0.95)$p.value
...
## 4.1 rate=2
### Summary
mysample = ars(n = 100,dexp, rate=2, x.start=c(0.01,3),plot.type="bounds")
mysample = ars(100,dexp, rate=2, x.start=c(0.01,3),plot.type="acceptance")
...
test_that("sampling ok",{
  x <- rexp(100,rate=2)
  y <- ars(100,dexp, rate=2,x.start=c(0.01,3))
  wilcox_test <- wilcox.test(x, y, 
                             alternative = c("two.sided", "less", "greater"),
                             mu = 0, paired = FALSE, exact = NULL, correct = TRUE,
                             conf.int = FALSE, conf.level = 0.95)$p.value
...
## 5.1 df=2
### Summary - Right plot?
mysample = ars(100,dchisq,df=2,x.start=c(0.001,10),plot.type="bounds")
mysample = ars(100,dchisq,df=2,x.start=c(0.001,10),plot.type="acceptance")
...
test_that("sampling ok",{
  x <- rchisq(100,df=2)
  y <- ars(100,dchisq,df=2,x.start=c(0.001,10))
  wilcox_test <- wilcox.test(x, y, 
                             alternative = c("two.sided", "less", "greater"),
                             mu = 0, paired = FALSE, exact = NULL, correct = TRUE,
                             conf.int = FALSE, conf.level = 0.95)$p.value
...
### Summary
mysample = ars(n = 100,dlogis, location=0, scale=1, x.start=c(-6,2),plot.type="bounds")
mysample = ars(100,dlogis, location=0, scale=1, x.start=c(-6,2),plot.type="acceptance")
...
test_that("sampling ok",{
  x <- rlogis(100, location=0, scale=1)
  y <- ars(100,dlogis,location=0, scale=1,x.start=c(-10,10))
  wilcox_test <- wilcox.test(x, y, 
                             alternative = c("two.sided", "less", "greater"),
                             mu = 0, paired = FALSE, exact = NULL, correct = TRUE,
                             conf.int = FALSE, conf.level = 0.95)$p.value
...
## 7.1 min=0 max=1
### Summary
mysample = ars(n = 100,dunif, min=0, max=1, x.start=c(0.1,0.9),plot.type="bounds")
mysample = ars(100,dunif, min=0, max=1, x.start=c(0.1,0.9),plot.type="acceptance")
...
test_that("sampling ok",{
  x <- runif(100)
  y <- ars(100,dunif,x.start=c(0.1,0.9))
  wilcox_test <- wilcox.test(x, y, 
                             alternative = c("two.sided", "less", "greater"),
                             mu = 0, paired = FALSE, exact = NULL, correct = TRUE,
                             conf.int = FALSE, conf.level = 0.95)$p.value
...
## 8.1 shape=1 scale=1
### Summary
mysample = ars(n = 100,dweibull, shape=1, scale=1, x.start=c(0.001,4),plot.type="bounds")
mysample = ars(100,dweibull, shape=1, scale=1, x.start=c(0.001,4),plot.type="acceptance")
...
test_that("sampling ok",{
  x <- rweibull(100,shape=1)
  y <- ars(100,dweibull,shape=1,x.start=c(0.001,4))
  wilcox_test <- wilcox.test(x, y, 
                             alternative = c("two.sided", "less", "greater"),
                             mu = 0, paired = FALSE, exact = NULL, correct = TRUE,
                             conf.int = FALSE, conf.level = 0.95)$p.value
...
### Summary
mysample = ars(n = 100,ddoublex, mu=0, lambda=1, x.start=c(-5,5),plot.type="bounds")
mysample = ars(100,ddoublex, mu=0, lambda=1, x.start=c(-5,5),plot.type="acceptance")
...
test_that("sampling ok",{
  x <- rdoublex(100)
  y <- ars(100,ddoublex,x.start=c(-5,5))
  wilcox_test <- wilcox.test(x, y, 
                             alternative = c("two.sided", "less", "greater"),
                             mu = 0, paired = FALSE, exact = NULL, correct = TRUE,
                             conf.int = FALSE, conf.level = 0.95)$p.value
...
test.sample = ars(100,f)
test.sample = ars(100,f,x.start=c(-2,2))
test.sample = ars(100,f,x.start=c(-2,2),plot.type="bounds")
test.sample = ars(100,f,x.start=c(-2,2),plot.type="acceptance")
test.sample = ars(100,f,plot.type="acceptance")
...
mysample = ars(n=100, f = sin, fprima = cos,x.start=c(3,1,2,0.1),plot.type="bounds")
mysample = ars(n=100, f = sin, x.start=c(3,1,2,0.1),plot.type="acceptance")
...
fprima = function(x) {-x}
## Our function
system.time(ars(1000, f=fprima,fprima=fprima,log.transform=TRUE,x.start=c(-4,4)))
#   user  system elapsed 
#  0.128   0.000   0.201 
rm(list=ls())
remove.packages("ars")
